...
class sync_up_enrolments_service extends service {
    ...
    function call() {
        ...
        try { 
            ...
            $categoryid = $this->sync_category_hierarchy($json);
            $courseid = $this->sync_course($categoryid, $json);
            ...
            foreach ($json->alunos as $aluno) {
                ...
                $this->sync_group($courseid, $userid, $aluno->polo);
            }
    ...
    function sync_category_hierarchy($data) {
    ...
    function sync_course($categoryid, $json){
        global $DB;
    ...
    function sync_group($courseid, $userid, $polo) {
        global $DB;
        if (empty($polo)) {
            return;
        }
